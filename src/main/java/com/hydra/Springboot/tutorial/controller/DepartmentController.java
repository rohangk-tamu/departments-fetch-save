package com.hydra.Springboot.tutorial.controller;
...
import com.hydra.Springboot.tutorial.service.DepartmentService;
...
public class DepartmentController {
    ...
    @GetMapping("/departments/name/{dept-name}")
    public Department fetchDepartmentByName(@PathVariable("dept-name") String deptName) {
